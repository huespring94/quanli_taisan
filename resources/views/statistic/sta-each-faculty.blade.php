...
<div class="box">
    <form class="form-horizontal" role="form" method="POST" action="{{route('statis-by-faculty-year')}}">
        {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <select name="faculty_id" class="form-control">
                        ...
                        <option {{!isset($facultyId) ? '' : ($fac->faculty_id == $facultyId ? "selected" : '')}} value="{{$fac->faculty_id}}">{{$fac->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-sm-2">
